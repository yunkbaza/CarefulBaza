      ...
      <div className="bg-white dark:bg-gray-900 py-12 border-t border-gray-100 dark:border-gray-800 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 md:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="p-6">
              <div className="w-16 h-16 bg-baza-lavender/5 dark:bg-baza-lavender/10 text-baza-lavender rounded-full flex items-center justify-center mx-auto mb-6 transition-colors">
