...
export default function CheckoutPage() {
  ...
  const FIXED_SHIPPING_COST_BRL = 25.90;
  
  const hasFreeShipping = cartTotal >= FREE_SHIPPING_GOAL_BRL;
  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-10 pb-32 transition-colors duration-300">
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 lg:px-16">
        ...
        <div className="py-8">
          <Link to="/shop" className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-gray-400 hover:text-baza-lavender dark:hover:text-baza-mint transition-colors">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="flex-1">
            <h1 className="font-syne text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-10 transition-colors">{t('checkout.title')}</h1>
            ...
            <form id="checkout-form" onSubmit={handleCheckout} className="space-y-12">
              ...
              <section>
                <h2 className="font-syne text-xl font-bold text-gray-900 dark:text-white mb-6 border-b border-gray-200 dark:border-gray-800 pb-4 transition-colors">2. {t('checkout.shipping_address')}</h2>
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                      ...
                      <input type="text" required value={cep} onChange={(e) => setCep(maskCEP(e.target.value))} className="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-4 py-3.5 text-sm text-gray-900 dark:text-white outline-none focus:border-baza-lavender dark:focus:border-baza-mint transition-colors shadow-sm" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-2">{t('checkout.city_label')}</label>
                    <input type="text" required className="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-4 py-3.5 text-sm text-gray-900 dark:text-white outline-none focus:border-baza-lavender dark:focus:border-baza-mint transition-colors shadow-sm" />
                  </div>
                </div>
              </section>
          ...
          <div className="lg:w-[420px] w-full">
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-8 shadow-xl sticky top-32 transition-colors duration-300">
              <h2 className="font-syne text-xl font-bold text-gray-900 dark:text-white mb-6 transition-colors">{t('checkout.order_summary')}</h2>
                ...
                {cartItems.map((item) => (
                  <div key={item.id} className="flex gap-4">
                    ...
                    <div className="flex-1 flex flex-col justify-center">
                      <h4 className="font-syne font-bold text-gray-900 dark:text-white text-sm line-clamp-1 transition-colors">
                      ...
                      <span className="font-mono text-sm font-bold text-gray-900 dark:text-white mt-1 transition-colors">
