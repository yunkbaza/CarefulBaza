...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col lg:flex-row bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      {/* 🖼️ Lado Esquerdo: Imagem com Texto de Luxo (CORRIGIDA) */}
      <div className="hidden lg:flex w-1/2 relative items-center justify-center overflow-hidden border-r border-gray-100 dark:border-gray-800">
        
        {/* Camada de Overlay Gradiente para Contraste do Texto */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-black/60 z-10"></div>
        
        {/* Imagem de Skincare de Alta Qualidade */}
        <img 
          src="https://images.unsplash.com/photo-1556228720-192a6af4e86e?q=80&w=1200&auto=format&fit=crop" 
          alt="Clean Beauty Texture" 
          className="absolute inset-0 w-full h-full object-cover" 
        />
        
        <div className="absolute z-20 text-center text-white px-12">
          <h2 className="font-syne text-5xl font-bold mb-4 drop-shadow-lg">Careful Baza Labs</h2>
          <p className="text-sm uppercase tracking-[0.3em] font-bold opacity-90 drop-shadow-md">
            The future of your skin starts here
          </p>
        </div>
      </div>

      {/* 📝 Lado Direito: Formulário */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 py-16 md:px-20 lg:px-32 bg-white dark:bg-gray-900 relative z-20">
