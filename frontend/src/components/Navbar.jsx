  ...
  return (
    <nav className="flex justify-between items-center py-5 px-8 md:px-16 border-b border-gray-100 bg-white/80 dark:bg-gray-900/90 dark:border-gray-800 backdrop-blur-md sticky top-0 z-50 transition-colors duration-300">
      ...
      <div className="flex items-center gap-5 md:gap-7 text-gray-900 dark:text-white">
        ...
        <button onClick={toggleDarkMode} aria-label="Toggle Dark Mode" className="hover:text-baza-lavender dark:hover:text-baza-mint transition-colors">
          {isDarkMode ? (
        ...
        <button onClick={onOpenSearch} aria-label="Search products" className="hover:text-baza-lavender dark:hover:text-baza-mint transition-colors hidden sm:block">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
        </button>

        {user ? (
          <Link to="/minha-conta" aria-label="Dashboard" className="hover:text-baza-lavender dark:hover:text-baza-mint transition-colors hidden md:block">
          ...
          <Link to="/login" aria-label="Login" className="hover:text-baza-lavender dark:hover:text-baza-mint transition-colors hidden md:block">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
          </Link>
        )}
        
        <button onClick={() => setIsCartOpen(true)} aria-label="Cart" className="hover:text-baza-lavender dark:hover:text-baza-mint transition-colors flex items-center gap-2 relative">
