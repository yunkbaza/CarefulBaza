    ...
    <main className="flex flex-col lg:flex-row min-h-[85vh]">
      <div className="flex-1 flex flex-col justify-center px-8 md:px-20 py-16 bg-white dark:bg-gray-900 transition-colors duration-300">
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <Link 
            to="/shop" 
            className="group w-fit bg-baza-lavender text-white px-10 py-4 text-xs font-bold uppercase tracking-widest hover:bg-gray-900 dark:hover:bg-white dark:hover:text-gray-900 hover:text-baza-mint transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 flex items-center gap-3"
          >
          ...
          <div className="flex items-center gap-2 mt-2">
            <div className="flex text-baza-lavender">
              {[1, 2, 3, 4, 5].map((star) => (
