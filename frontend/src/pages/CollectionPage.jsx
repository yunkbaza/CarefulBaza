    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300 pt-10 pb-24 px-6 md:px-16">
        ...
        {processedProducts.map((product) => (
          <Link to={`/produto/${product.id}`} key={product.id} className="group flex flex-col">
            ...
            <div className="flex flex-col flex-1">
              ...
              <h3 className="font-syne font-bold text-gray-900 dark:text-white text-base mb-2 group-hover:text-baza-lavender dark:group-hover:text-baza-mint transition-colors">{product.name}</h3>
      ...
      {processedProducts.length === 0 && (
        <div className="text-center py-24 flex flex-col items-center">
          ...
          <Link to="/shop" className="bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-8 py-3 text-[10px] font-bold uppercase tracking-widest hover:bg-baza-lavender dark:hover:bg-baza-mint hover:text-white transition-colors">
