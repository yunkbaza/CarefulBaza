...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white pb-24">
      ...
      {/* A Carta do Fundador (Conexão e Confiança) */}
      <div className="max-w-4xl mx-auto px-6 md:px-16 mb-24">
        <div className="bg-gray-50 border border-gray-100 p-8 md:p-12 relative">
          <svg className="absolute top-6 left-6 w-12 h-12 text-gray-200" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/></svg>
          
          <div className="relative z-10 pt-6">
            <span className="text-[10px] font-bold uppercase tracking-widest text-baza-lavender mb-4 block">Uma mensagem do fundador</span>
            <h2 className="font-syne text-3xl font-bold text-gray-900 mb-6 leading-tight">"Na tecnologia, um código mal escrito quebra o sistema. Na pele, um ingrediente ruim quebra a sua barreira de proteção."</h2>
            ...
            <div className="flex items-center gap-4 border-t border-gray-200 pt-6">
              <div className="w-12 h-12 bg-gray-900 rounded-full flex items-center justify-center text-white font-syne font-bold text-xl">
                A.
              </div>
              <div>
                <p className="font-syne font-bold text-gray-900">Allan</p>
                <p className="text-[10px] uppercase tracking-widest text-gray-500 font-bold">Fundador, Careful Baza Labs</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white py-12 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-16">
          <div className="text-center mb-16">
            ...
            <h2 className="font-syne text-3xl md:text-4xl font-bold text-gray-900">O Padrão Baza de Qualidade.</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="p-6">
              <div className="w-16 h-16 bg-baza-lavender/5 text-baza-lavender rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <h3 className="font-syne text-xl font-bold text-gray-900 mb-3">Segurança e Transparência</h3>
              <p className="text-gray-500 text-sm leading-relaxed">Você sabe exatamente o que está comprando. Nosso ambiente de pagamento possui criptografia de ponta a ponta e seus dados estão 100% blindados.</p>
            </div>
            ...
            <div className="p-6">
              ...
              <h3 className="font-syne text-xl font-bold text-gray-900 mb-3">Fórmulas Biocompatíveis</h3>
              <p className="text-gray-500 text-sm leading-relaxed">Não testamos em animais. Formulamos apenas com ativos limpos, livres de toxinas, que a sua pele reconhece e absorve com máxima eficiência.</p>
            </div>
            ...
            <div className="p-6">
              ...
              <h3 className="font-syne text-xl font-bold text-gray-900 mb-3">Logística de Ponta</h3>
              <p className="text-gray-500 text-sm leading-relaxed">Da nossa curadoria direto para a sua casa. Processamento rápido de pedidos e rastreamento em tempo real para você acompanhar cada passo da entrega.</p>
            </div>
          </div>
        </div>
      </div>
