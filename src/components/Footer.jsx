        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 mb-16 pb-16 border-b border-gray-800 dark:border-gray-900 transition-colors duration-300">
          <div className="lg:w-1/3">
            ...
            <div className="flex items-center gap-4">
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full border border-gray-700 dark:border-gray-800 flex items-center justify-center text-gray-400 hover:text-baza-lavender hover:border-baza-lavender dark:hover:border-baza-lavender transition-all">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </a>
              <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full border border-gray-700 dark:border-gray-800 flex items-center justify-center text-gray-400 hover:text-baza-lavender hover:border-baza-lavender dark:hover:border-baza-lavender transition-all">
          ...
          <div className="lg:w-1/2 w-full bg-gray-800/50 dark:bg-gray-900/50 p-8 rounded-sm border border-gray-800 dark:border-gray-900 transition-colors duration-300">
            ...
            <form className="flex flex-col sm:flex-row gap-3">
              <input 
                ...
                className="flex-1 bg-gray-900 dark:bg-black border border-gray-700 dark:border-gray-800 px-4 py-3 text-sm text-white outline-none focus:border-baza-lavender transition-colors duration-300"
              />
              <button type="button" className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white px-8 py-3 text-[10px] font-bold uppercase tracking-widest hover:bg-baza-lavender hover:text-white dark:hover:bg-baza-lavender transition-colors duration-300">
                Assinar
              </button>
            </form>
          </div>
